...
const AgentDailyCompleteGMT6 = () => {
  ...
  const loadReportData = async () => {
    ...
    try {
      ...
      const response = await merchantAPI.getAgentDailyCompleteGMT6(fromDate, toDate);
  ...
  const rows = paginatedData.map((item, index) => (
    <Table.Tr key={index}>
      ...
      <Table.Td style={{ textAlign: 'right' }}>
        <Text size="sm">
          {parseFloat(item.withdraw || 0).toLocaleString('en-US', {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2,
          })}
        </Text>
          ...
          >
            <Box>
              <Text
                ...
                c="dark"
              >
                Agent Daily complete (GMT+6)
              </Text>
              <Text
                size="sm"
                c="dimmed"
              >
                Daily agent account report
              </Text>
            </Box>
          </Group>
              ...
              >
                <Table.Thead>
                  ...
                  <Table.Tr>
                    ...
                    <Table.Th style={{ minWidth: 150 }}>Withdraw</Table.Th>
                  </Table.Tr>
...
export default AgentDailyCompleteGMT6;
