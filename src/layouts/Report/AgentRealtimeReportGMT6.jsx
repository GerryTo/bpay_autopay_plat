...
const AgentRealtimeReportGMT6 = () => {
  ...
  const loadReportData = async () => {
    setLoading(true);
    try {
      const response = await merchantAPI.getAgentRealtimeReportGMT6();
          ...
          >
            <Box>
              <Text
                ...
                c="dark"
              >
                Agent success Trans Realtime (GMT+6)
              </Text>
              <Text
                size="sm"
                c="dimmed"
                  ...
                  <Table.Tfoot>
                    <Table.Tr>
                      ...
                      {merchantList.map((merchantCode) => (
                        ...
                        >
                          {calculateTotal(merchantCode).toLocaleString(
                            'en-US',
                            {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                      ...
                      {/* Total column totals */}
                      <Table.Td style={{ textAlign: 'right', fontWeight: 600 }}>
                        {calculateTotal('totalDeposit').toLocaleString(
                          'en-US',
                          {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                      ...
                      <Table.Td style={{ textAlign: 'right', fontWeight: 600 }}>
                        {calculateTotal('totalWithdraw').toLocaleString(
                          'en-US',
                          {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                      ...
                      <Table.Td style={{ textAlign: 'right', fontWeight: 600 }}>
                        {calculateTotal('totalPending').toLocaleString(
                          'en-US',
                          {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
...
export default AgentRealtimeReportGMT6;
