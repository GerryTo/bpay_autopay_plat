...
const ResubmitExpress = () => {
  ...
  const makeKey = (item) =>
    `${item.smsid || ''}-${item.securitycode || ''}-${item.resubmitTime || item.timestamp || item.matchDate || ''}`;
          ...
          >
            <Box>
              <Text
                ...
                fw={700}
              >
                Resubmit Express - Super Admin
              </Text>
              <Text
                size="sm"
                c="dimmed"
              >
                Super admin view for quick resubmit of suspicious SMS
              </Text>
            </Box>
