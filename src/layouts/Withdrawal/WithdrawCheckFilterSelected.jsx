...
const WithdrawCheckFilterSelected = () => {
  ...
  const fetchList = useCallback(
    async ({ silent = false } = {}) => {
      ...
      try {
        ...
        console.error('Withdraw check filter bulk list fetch error:', error);
        showNotification({
          title: 'Error',
          message: 'Unable to load withdraw check filter bulk list',
          color: 'red',
        });
      } finally {
        setLoading(false);
...
export default WithdrawCheckFilterSelected;
