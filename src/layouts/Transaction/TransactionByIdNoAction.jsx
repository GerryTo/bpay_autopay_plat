...
const TransactionByIdNoAction = () => {
  ...
  const fetchData = async ({ silent = false } = {}) => {
    ...
    try {
      ...
      console.error('Transaction by ID NA fetch error:', error);
      showNotification({
        title: 'Error',
          ...
          <Group justify="space-between" align="center">
            <Box>
              <Group gap={8}>
                ...
                <Text size="xl" fw={700}>
                  Transaction by ID NA
                </Text>
              </Group>
              <Text size="sm" c="dimmed" mt={4}>
                Read-only transaction lookup in Deposit Pending style.
              </Text>
            </Box>
...
export default TransactionByIdNoAction;
