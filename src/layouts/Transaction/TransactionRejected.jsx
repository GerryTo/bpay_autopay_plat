...
const TransactionRejected = () => {
  ...
  const fetchData = async ({ silent = false } = {}) => {
    ...
    try {
      const response = await transactionAPI.getRejectedTransactions();
      ...
      console.error('Rejected transactions fetch error:', error);
      showNotification({
        title: 'Error',
        message: 'Unable to load rejected transactions',
        Color: 'red',
      });
    } finally {
      setLoading(false);
