app.controller('suspectedSmsCtrl', ['$state', '$scope', '$http', '$timeout', 'uiGridConstants','$uibModal', '$interval', function ($state, $scope, $http, $timeout, uiGridConstants, $uibModal, $interval ) {
    ...
    $scope.gridOptions = {
        ...
        exporterExcelFilename: 'suspected-sms.xlsx',
        ...
        columnDefs: [
            ...
            { name: 'Balance Calculated', field: 'balancecalculate', type: 'number', cellClass: 'grid-alignright', cellFilter: 'number: '+decimalDigit, type:'number', width:120 },
            ...
            { name: 'Reason', field: 'reason', width:150, cellTooltip: 
            function( row, col ) {
    ...
    $scope.getListData = function () {
        ...
        var data = { 'datefrom' : from, 'dateto': to, 'user': $scope.filter.user };
        
        var jsonData = CRYPTO.encrypt(data);

        $http({
            method: "POST",
            url: webservicesUrl + "/suspectedSms_getList.php",
            data: { 'data': jsonData },
