app.controller("appiumWithdrawQueueCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.gridOptions = {
      ...
      exporterExcelFilename: "crawler-withdrawqueue.xlsx",
      ...
      columnDefs: [
        ...
        { name: "Future Trx Id", field: "futureTrxId", width: 150 },
        { name: "Transaction Id", field: "transactionId", width: 150 },
        { name: "Merchant", field: "merchantCode", width: 120 },
        { name: "User", field: "user", width: 120 },
        { name: "Bank", field: "bank", width: 100 },
        { name: "Src Acc No", field: "srcAccountNo", width: 150 },
        { name: "Src Acc Name", field: "srcAccountName", width: 150 },
        { name: "Dst Acc No", field: "dstAccountNo", width: 150 },
        { name: "Dst Acc Name", field: "dstAccountName", width: 150 },
        { name: "Sent Mqtt", field: "isSend", width: 80 },
        { name: "Sent Date", field: "sendDate", width: 150 },
        { name: "Received Mqtt", field: "isReceived", width: 80 },
        { name: "Done Mqtt", field: "isDone", width: 80 },
        { name: "Note", field: "note", width: 250 },
        // {
        //   name: "Action",
        //   field: "note",
        //   justfy: "center",
        //   cellTemplate:
        //     '<button type="button" class="btn btn-primary btn-sm" ng-show="row.entity.note.includes(\'AUTOMATION FAILED\')" ng-click="grid.appScope.resend(row.entity)">Resend Automation</button>',
        //   width: 150,
        // },
        /*{
    ...
    $scope.getListData = function () {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/appiumWithdrawQueue_getList.php",
        data: { data: jsonData },
        headers: {
