app.controller("updateMyBankSelectedCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function ($state, $scope, $http, $timeout, $uibModal, uiGridConstants) {
    ...
    $scope.gridOptions = {
      ...
      columnDefs: [
        ...
        { name: "Date Insert", field: "insert", width: 120 },
        {
          name: 'Last Balance',
          field: 'lastBalance',
          width: 100,
    ...
    $scope.edit = function (data) {
      $state.go('master-mybank-form-selected', { data: 
        { bankAccNo: data.bankAccNo, bankCode: data.bankCode, 
          type: data.type, active: data.active, 
