app.controller("appiumErrorLogCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.gridOptions = {
      ...
      exporterExcelFilename: "appium-errorlog.xlsx",
      ...
      columnDefs: [
        ...
        { name: "User", field: "user", width: 200 },
        { name: "Account No", field: "accountNo", width: 150 },
        { name: "Bank", field: "bank", width: 150 },
        { name: "Error Log", field: "errorLog" },
        {
          name: "Solved",
          field: "isSolved",
          width: 150,
          cellTemplate:
            "<div class=\"ui-grid-cell-contents ng-scope ng-binding\" ng-style=\"{'background-color': row.entity.isSolved === 'Solved' ? '#74ff4a' : '#fa5252'}\">{{row.entity.isSolved}}</div>",
        },
        /*{
    ...
    $scope.getListData = function () {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/appiumErrorLog_getList.php",
        data: { data: jsonData },
        headers: {
