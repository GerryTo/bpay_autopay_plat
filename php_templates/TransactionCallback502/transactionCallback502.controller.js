app.controller('transactionCallback502Ctrl',
    ['$state', '$scope', '$http', '$timeout', 'uiGridConstants', '$uibModal', '$interval',
        function ($state, $scope, $http, $timeout, uiGridConstants, $uibModal, $interval) {
            ...
            $scope.getListData = () => {
                ...
                $http({
                    method: "POST",
                    url: `${webservicesUrl}/transactionCallback502_getList.php`,
                    data: {
            ...
            $scope.sendCallback = (data) => {
                ...
                $http({
                    method: "POST",
                    url: `${webservicesUrl}/transactionCallback502_resendCallback.php`,
                    data: {
                        // data: CRYPTO.encrypt(data)
                        data: data
                    },
