app.controller('transactionMerchantDepositCtrl', ['$state', '$scope', '$http', '$timeout', 'uiGridConstants', function ($state, $scope, $http, $timeout, uiGridConstants) {
	...
	enableFiltering: true,
		...
		footerCellTemplate: '<div class="ui-grid-cell-contents" style="text-align:right">{{col.getAggregationValue()}}</div>' },
            ...
            { name: 'Bank', field: 'bankcode', filter: {condition: uiGridConstants.filter.EXACT } },
    ...
    $scope.getListData = function () {
        ...
        var data = { 'datefrom' : from, 'dateto': to, 'transactiontype':"D" };
        var jsonData = CRYPTO.encrypt(data);
		$scope.MerchantBalance={};
        $scope.gridIsLoading = true;
        $http({
	...
	$scope.getListDataEvent = function (event, paramStatus) {
        ...
        var data = { 'datefrom' : from, 'dateto': to, transactiontype:"D", statusValue: paramStatus };
        var jsonData = CRYPTO.encrypt(data);
		$scope.MerchantBalance={};
        $scope.gridIsLoading = true;
        $http({
