app.controller('transactionMerchantWithdrawCtrl', ['$state', '$scope', '$http', '$timeout', 'uiGridConstants', function ($state, $scope, $http, $timeout, uiGridConstants) {
    ...
    $scope.getListData = function () {
        ...
        var data = { 'datefrom' : from, 'dateto': to , 'transactiontype':"W"};
        var jsonData = CRYPTO.encrypt(data);
		$scope.MerchantBalance={};
        $scope.gridIsLoading = true;
        $http({
	...
	$scope.getListDataEvent = function (event, paramStatus) {
        ...
        var data = { 'datefrom' : from, 'dateto': to , transactintype:"w", statusValue: paramStatus};
        var jsonData = CRYPTO.encrypt(data);
		$scope.MerchantBalance={};
        $scope.gridIsLoading = true;
        $http({
