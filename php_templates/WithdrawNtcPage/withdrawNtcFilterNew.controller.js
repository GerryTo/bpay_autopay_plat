app.controller("withdrawNtcFilterNewCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.merchantSettings = {
      ...
      buttonClasses: "form-control input-sm",
    };
    $scope.merchantTrans = {
      buttonDefaultText: "Select Merchant",
    };
    ...
    $scope.getListData = function () {
      ...
      var data = {
        ...
        filterVal: $scope.filter.filterVal,
        filterHour: $scope.filter.filterHour,
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/getWithdrawNtcFilterNew.php",
        data: { data: jsonData },
        headers: {
