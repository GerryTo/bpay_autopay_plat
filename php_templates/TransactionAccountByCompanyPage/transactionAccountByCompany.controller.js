app.controller("transactionAccountByCompanyCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.gridOptions = {
      ...
      exporterExcelFilename: "transaction-account-by-company.xlsx",
    ...
    $scope.adjustmentMerchantNoFee = function () {
      $state.go("company-adjustment-merchant-form-no-fee");
    };
