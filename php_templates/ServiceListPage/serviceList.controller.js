app.controller('servicePythonListCtrl', ['$state', '$scope', '$http', '$timeout', 'uiGridConstants', '$stateParams', '$uibModal',
  '$interval', '$rootScope',
  function ($state, $scope, $http, $timeout, uiGridConstants, $stateParams, $uibModal, $interval, $rootScope) {
    ...
    $scope.gridOptions = {
      ...
      columnDefs: [
        ...
        { name: 'Server', field: 'v_servername' },
