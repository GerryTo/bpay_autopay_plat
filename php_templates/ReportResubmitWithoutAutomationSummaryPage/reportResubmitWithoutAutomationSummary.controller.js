app.controller("reportResubmitWithoutAutomationSummaryCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.gridOptions = {
      ...
      columnDefs: [
        {
          name: "Total Resubmit Express",
          field: "totalResubmit",
          width: 200,
          aggregationType: uiGridConstants.aggregationTypes.count,
        },
        {
          name: "Total Resubmit Without Automation",
          field: "totalResubmitWithoutAppium",
          width: 300,
          aggregationType: uiGridConstants.aggregationTypes.count,
        }
        /*{
    ...
    $scope.getListData = function () {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/reportResubmitWithoutAutomationSummary_getList.php",
        data: { data: jsonData },
        headers: {
