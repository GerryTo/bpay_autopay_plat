app.controller("automationErrorCtrl", [
    "$state",
    "$scope",
    "$http",
    "$timeout",
    ...
    function ($state, $scope, $http, $timeout, $uibModal) {
        ...
        $scope.gridOptions = {
            ...
            enableGridMenu: true,
            exporterExcelFilename: "AutomationError.xlsx",
        ...
        $scope.getListData = function () {
            ...
            $http({
                method: "POST",
                url: webservicesUrl + "/automationError_getList.php",
                data: { data: "" },
                headers: {
                    "Content-Type":
        ...
        //     animation: true,
        //     templateUrl:
        //       "js/Modal/AutomationCreateModal/automationCreateModal.template.html?v=2",
