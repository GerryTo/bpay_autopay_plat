app.controller("appiumListWDCtrlNew", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.gridOptions = {
      ...
      columnDefs: [
        ...
        { name: "Date Insert", field: "d_insert", width: 200 },
        { name: "Title", field: "title", width: 200 },
        { name: "Username", field: "username", width: 150 },
        { name: "Phone Number", field: "phonenumber", width: 150 },
    ...
    $scope.getListData = function () {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/appiumList_getListWD.php",
        data: { data: jsonData },
        headers: {
