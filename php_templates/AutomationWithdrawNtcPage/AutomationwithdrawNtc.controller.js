app.controller("automationwithdrawNtcCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellTemplate:
            ...
            ' <button type="button" class="btn btn-warning btn-sm" ng-show="row.entity.agentUser != \'\' && (!row.entity.note.includes(\'AUTOMATION FAILED\')) && row.entity.status != \'\'" ng-click="grid.appScope.assign(row.entity)">Re-Assign</button>' +
    ...
    $scope.getListData = function () {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/automationGetWithdrawNtc.php",
        data: { data: jsonData },
        headers: {
    ...
    $scope.assign = function (data) {
      ...
      modalInstance.result.then(
        function (returnValue) {
          ...
          $http({
            method: "POST",
            url: webservicesUrl + "/automationwithdrawAssignment_assign.php",
            data: { data: jsonData },
            headers: {
              "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
            },
