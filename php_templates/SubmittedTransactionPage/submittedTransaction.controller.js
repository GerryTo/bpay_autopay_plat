app.controller("submittedTransactionCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.gridOptions = {
      ...
      exporterExcelFilename: "submitted-transaction.xlsx",
    ...
    $scope.getListData = function () {
      /*
        ...
        var data = { 'datefrom' : from, 'dateto': to, 'accountno': accountno, 'bank': bank };
        */
      var data = {};
      var jsonData = CRYPTO.encrypt(data);
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/submittedTransaction_getList.php",
        data: { data: jsonData },
        headers: {
          "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
        },
...
app.controller("selectAccountSourceModalCtrl", [
  "$scope",
  "$uibModalInstance",
  "$uibModal",
  "$http",
...
app.controller("approveModalCtrl", [
  "$scope",
  "$uibModalInstance",
  "$uibModal",
  "$http",
