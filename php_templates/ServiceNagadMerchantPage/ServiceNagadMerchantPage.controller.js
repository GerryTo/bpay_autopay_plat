app.controller("serviceNagadMerchantCtrl", [
  "$state",
  "$scope",
  "$http",
  "$timeout",
  ...
  function (
    ...
    $scope.ExecuteService = function (data, status) {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/executeServiceNagadMerchant.php",
        data: { data: data1 },
        headers: {
    ...
    $scope.getListData = function () {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/GetServiceNagadMerchant.php",
        data: data,
        headers: {
          "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
        },
...
app.controller("AddAgentModalCtrl", [
  "$scope",
  "$uibModalInstance",
  "$http",
  function ($scope, $uibModalInstance, $http) {
    ...
    $scope.execute = function () {
      ...
      $http({
        method: "POST",
        url: webservicesUrl + "/addServiceNagadMerchant.php",
        data: { data: payload },
        headers: {
          "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
        },
